    ...
    <section className="py-20 px-4 ">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          {/* Main Title */}
          <h2 className="text-7xl md:text-8xl font-light text-stone-800 mb-4">
            Categories
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
          {categories.map((category, index) => (
            <button
              key={index}
              className="group relative p-6 bg-white/40 backdrop-blur-sm rounded-2xl hover:bg-white transition-all duration-300 border border-stone-200/50 hover:border-amber-200/50 shadow-sm hover:shadow-md text-center cursor-pointer"
            >
              {/* Category Name */}
